...
//                Intent intent = new Intent(getActivity(),ActivityItemSelection.class);
                //intent.putExtra("CATEGORY_NAME",category);
                //startActivity(intent);

                mListener.selectedCategory(category);
            }
        });

        orderListRV.setAdapter(categoryAdapter);

        VolleyGetService.syncAllItemCategory(getActivity(), baseUrl+"api/item/cat/categories", new VolleyGetService.CategoryDelegate() {
            @Override
